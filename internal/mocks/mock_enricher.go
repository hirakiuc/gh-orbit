...
func (_m *MockEnricher) FetchHybridBatch(ctx context.Context, notifications []triage.NotificationWithState) map[string]types.EnrichmentResult {
	...
	if rf, ok := ret.Get(0).(func(context.Context, []triage.NotificationWithState) map[string]types.EnrichmentResult); ok {
...
func (_c *MockEnricher_FetchHybridBatch_Call) RunAndReturn(run func(context.Context, []triage.NotificationWithState) map[string]types.EnrichmentResult) *MockEnricher_FetchHybridBatch_Call {
	_c.Call.Return(run)
	return _c
}
