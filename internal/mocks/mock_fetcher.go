...
func (_m *MockFetcher) FetchNotifications(ctx context.Context, meta *types.SyncMeta, force bool) ([]types.GHNotification, *types.SyncMeta, int, error) {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *types.SyncMeta, bool) *types.SyncMeta); ok {
		r1 = rf(ctx, meta, force)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*types.SyncMeta)
		}
	}
...
func (_c *MockFetcher_FetchNotifications_Call) Run(run func(ctx context.Context, meta *types.SyncMeta, force bool)) *MockFetcher_FetchNotifications_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*types.SyncMeta), args[2].(bool))
	})
	return _c
}
